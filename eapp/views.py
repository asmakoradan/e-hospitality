...
# -------------------------------prescription-----------------
#----------Prescribe Medicine View (Doctor)


@login_required(login_url='doctorlogin')
@user_passes_test(is_doctor)
def prescribe_medicine_view(request, patient_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            prescription.save()
            return redirect('doctor-patient-prescriptions', patient_id=patient_id)
    else:
        form = forms.PrescriptionForm()
    return render(request, 'hospital/prescribe_medicine.html', {'form': form, 'patient': patient})


#-----Patient Prescription List View (Doctor)
...
def patient_prescriptions_view(request, patient_id):
    ...
    return render(request, 'hospital/patient_prescriptions.html', {'prescriptions': prescriptions, 'patient': patient})
...
@login_required(login_url='doctorlogin')
@user_passes_test(is_doctor)
def send_prescription_to_pharmacy_view(request, prescription_id):
    ...
    if request.method == 'POST':
        ...
        # Send prescription to pharmacy via email or API
        send_mail(
        ...
        return redirect('doctor-patient-prescriptions', patient_id='patient_id')
    return render(request, 'hospital/send_prescription_to_pharmacy.html',
                  {'prescription': prescription, 'pharmacies': pharmacies})
